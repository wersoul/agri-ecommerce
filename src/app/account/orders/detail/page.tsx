...
function OrderDetailContent() {
  ...
  useEffect(() => {
    if (!hydrated) return;
    if (!id) {
      // ไม่มี id → กลับไปหน้าประวัติการสั่งซื้อ
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-3xl mx-auto">
        <Link href="/account/orders" className="text-primary-700 hover:underline text-sm mb-4 inline-block">← กลับไปประวัติการสั่งซื้อ</Link>
